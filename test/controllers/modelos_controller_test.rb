...
class ModelosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create modelo" do
    assert_difference('Modelo.count') do
      post modelos_url, params: { modelo: { activo: @modelo.activo, modelo: @modelo.modelo } }
    end
  ...
  test "should update modelo" do
    patch modelo_url(@modelo), params: { modelo: { activo: @modelo.activo, modelo: @modelo.modelo } }
